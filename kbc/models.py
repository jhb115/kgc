...
#     def __init__(self, sizes: Tuple[int, int, int], rank: int, sorted_data: np.ndarray,
#                  slice_dic: np.ndarray, max_NB: int = 50, init_size: float = 1e-3,
#                  data_name: str = 'FB15K'):
#
...
#         index_tensor = torch.LongTensor(index_array).cuda()
#
#         nb_rhs = self.embeddings[0](index_tensor)
#         nb_rhs = nb_rhs[:, :, :self.rank], nb_rhs[:, :, self.rank:]
#
#         return nb_rhs
#
#     def score(self, x):
